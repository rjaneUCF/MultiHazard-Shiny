This repository contains code for a Shiny app for a bivarite joint probability analysis. The app extensivly calls R functions in the [MultiHazard package](https://github.com/rjaneUCF/MultiHazard). 
